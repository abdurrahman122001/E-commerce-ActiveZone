    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <div class="d-block text-center my-3">
                @if (Auth::user()->shop && Auth::user()->shop->logo != null)
                ...
                @endif
                <h3 class="fs-16  m-0 text-primary">{{ Auth::user()->shop ? Auth::user()->shop->name : Auth::user()->name }}</h3>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('vendor.products') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['vendor.products', 'vendor.products.create', 'vendor.products.edit']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Products') }}</span>
                            </a>
                        </li>
