                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="thumbnail_img_file-preview-container mt-3" style="display: {{ $product->thumbnail_img ? 'block' : 'none' }}">
                                        ...
                                        @foreach(explode(',', $product->photos) as $photo)
                                            <div class="mr-2 mb-2">
                                                <img class="img-fluid rounded shadow-sm" 
                                                    ...
                                                    style="max-height: 100px; border: 1px solid #ddd; background: #f8f9fa; padding: 5px;">
                                            </div>
                                        @endforeach
                                    @endif
                                </div>
