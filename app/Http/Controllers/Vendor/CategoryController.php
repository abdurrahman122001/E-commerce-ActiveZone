...
class CategoryController extends Controller
{
    public function index()
    {
        ...
        return view('vendors.category.index', compact('categories'));
    }
    ...
    public function create()
    {
        $categories = Category::where('parent_id', 0)
            ...
            ->get();
        return view('vendors.category.create', compact('categories'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->with('childrenCategories')
            ->get();
        return view('vendors.category.edit', compact('category', 'categories'));
    }
