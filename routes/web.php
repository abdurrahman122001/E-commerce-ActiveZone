...
Route::controller(App\Http\Controllers\FranchiseController::class)->group(function () {
    ...
    Route::get('/franchise/state', 'showStateFranchiseLandingPage')->name('franchise.state_landing');
    ...
    Route::group(['middleware' => ['auth', 'admin']], function () {
        ...
        Route::post('/admin/franchise/request-additional-docs/{id}/{type}', 'requestAdditionalDocs')->name('admin.franchise.request_additional_docs');
...
Route::controller(App\Http\Controllers\LocationController::class)->group(function () {
    ...
    Route::get('/location/get-countries', 'getAvailableCountries')->name('location.get-countries');
